...
args.det_checkpoint = 'checkouts/faster_rcnn_r50_fpn_1x_coco-person_20201216_175929-d022e227.pth'  # noqa: E501
args.det_score_thr = 0.5
args.pose_config = 'demo/demo_configs/td-hm_hrnet-w32_8xb64-210e_coco-256x192_infer.py'  # noqa: E501
args.pose_checkpoint = 'checkouts/hrnet_w32_coco_256x192-c78dce93_20200708.pth'  # noqa: E501
...
def ntu_pose_extraction(vid, skip_postproc=True):
    ...
    folder_name = osp.basename(osp.dirname(vid))
    anno['label'] = folder_name.split('.')[1]
    tmp_dir.cleanup()
